    ...
    <div className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-0 w-full">
        ...
        <div className="relative w-full">
          {/* Back hill - tallest */}
          <div className="absolute bottom-0 w-full h-[25rem] bg-gradient-to-t from-white to-white/90 md:rounded-[100%] rounded-none transform scale-110 translate-y-40" />
          
          {/* Middle hill */}
          <div className="absolute bottom-0 w-full h-[24rem] bg-gradient-to-t from-white to-white/95 md:rounded-[100%] rounded-none transform scale-105 translate-y-32" />
          ...
          <div className="absolute bottom-0 w-full h-80 bg-gradient-to-b from-transparent to-blue-100/20 translate-y-24" />
        </div>
      </div>
