    ...
    <div className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-0 w-full">
        ...
        <div className="relative w-full">
          {/* Back hill - tallest */}
          <div className="absolute bottom-0 w-max h-[15rem] bg-gradient-to-t from-white to-white/90 md:rounded-[100%] rounded-none transform scale-110 translate-y-40" />
          
          {/* Middle hill */}
          <div className="absolute bottom-0 w-max h-[15rem] bg-gradient-to-t from-white to-white/95 md:rounded-[100%] rounded-none transform scale-105 translate-y-32" />
