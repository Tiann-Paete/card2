    ...
    <div className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-0 w-full">
        ...
        <div className="relative w-full">
          {/* Back hill - tallest */}
          <div className="absolute bottom-0 w-full h-[15rem] bg-gradient-to-t from-white to-white/90 md:rounded-[100%] rounded-none transform scale-125 translate-y-40" />
          
          {/* Middle hill */}
          <div className="absolute bottom-0 w-full h-[15rem] bg-gradient-to-t from-white to-white/95 md:rounded-[100%] rounded-none transform scale-125 translate-y-32" />
          
          {/* Front hill - main snow ground */}
          <div className="absolute bottom-0 w-full h-72 bg-white md:rounded-[100%] rounded-none translate-y-24" />
